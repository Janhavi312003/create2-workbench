import { FaBitcoin, FaEthereum, FaShieldAlt, FaRocket, FaCode, FaUsers, FaHeart } from 'react-icons/fa'
...
export function About() {
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      {/* Rootstock Section */}
      <div className="bg-gray-900/70 backdrop-blur-sm rounded-3xl p-8 md:p-12 border border-gray-700 mb-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
          <div className="bg-black/50 rounded-2xl p-6 border border-gray-800">
            ...
            <p className="text-[#a0a0a0] text-sm">Secured by merge-mining with Bitcoin's massive hashing power</p>
          </div>
          <div className="bg-black/50 rounded-2xl p-6 border border-gray-800">
            <FaEthereum className="text-orange-500 text-2xl mb-4" />
            <h3 className="text-white font-bold mb-2">EVM Compatible</h3>
            <p className="text-[#a0a0a0] text-sm">Full support for Ethereum smart contracts and development tools</p>
          </div>
          <div className="bg-black/50 rounded-2xl p-6 border border-gray-800">
            <BsLightningCharge className="text-orange-500 text-2xl mb-4" />
            <h3 className="text-white font-bold mb-2">Native RBTC</h3>
            <p className="text-[#a0a0a0] text-sm">1:1 Bitcoin-pegged native currency for transactions</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gray-900/70 backdrop-blur-sm rounded-3xl p-8 md:p-12 border border-gray-700 mb-8">
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-8">
          <div className="text-center">
            ...
            <p className="text-[#a0a0a0] text-sm">Know contract addresses before deploying</p>
          </div>
          <div className="text-center">
            <div className="text-4xl font-bold text-orange-500 mb-2">💎</div>
            <h3 className="text-white font-bold mb-2">Vanity Mining</h3>
            <p className="text-[#a0a0a0] text-sm">Find custom address prefixes like 0x0000...</p>
          </div>
          <div className="text-center">
            <div className="text-4xl font-bold text-orange-500 mb-2">⚡</div>
            <h3 className="text-white font-bold mb-2">Non-Blocking</h3>
            <p className="text-[#a0a0a0] text-sm">Web Workers for background vanity search</p>
          </div>
        </div>
      </div>

      {/* Technology Stack */}
      <div className="bg-gray-900/70 backdrop-blur-sm rounded-3xl p-8 md:p-12 border border-gray-700">
        <h2 className="text-3xl font-bold text-white mb-6 flex items-center gap-3">
