...
import { FaGithub, FaTwitter, FaDiscord, FaBook, FaExternalLinkAlt, FaHeart } from 'react-icons/fa'
    ...
    <footer className="bg-black border-t border-[#2a2a2a] mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* About Section */}
          <div>
            <h3 className="text-white font-bold text-lg mb-4">Rootstock CREATE2 Workbench</h3>
            <p className="text-[#a0a0a0] text-sm mb-4">
              Calculate deterministic contract addresses and deploy with CREATE2 on Rootstock (RSK) blockchain.
            </p>
        ...
        <div className="mt-8 pt-8 border-t border-[#2a2a2a]">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-[#a0a0a0] text-sm">
              © {currentYear} Rootstock CREATE2 Workbench. All rights reserved.
            </p>
            <p className="text-[#a0a0a0] text-sm">
